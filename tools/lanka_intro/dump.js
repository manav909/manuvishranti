...
fs.writeFileSync(__dirname+'/lkdata.json',JSON.stringify(d));console.log(Object.keys(d.ROLE).length,d.NIGHTS.length,d.PL.length,JSON.stringify(d).length);await b.close();})();
